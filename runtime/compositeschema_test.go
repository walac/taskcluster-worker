...
func TestConflictingMergedCompositeSchemas(t *testing.T) {
	...
	`
	c1, err := NewCompositeSchema("prop", schema1, true, func() interface{} { return nil })
	...
	`
	c2, err := NewCompositeSchema("prop", schema2, true, func() interface{} { return nil })
...
func TestRequiredSchemaPropertyMissing(t *testing.T) {
	...
	`
	c, err := NewCompositeSchema("prop", schema, true, func() interface{} { return &Target{} })
	if err != nil {
		t.Fatal(err)
	}
...
func TestUnrequiredSchemaPropertyMissing(t *testing.T) {
	...
	`
	c, err := NewCompositeSchema("prop", schema, false, func() interface{} { return &Target{} })
	if err != nil {
		t.Fatal(err)
	}
